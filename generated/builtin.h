...
const uint32_t flash_utils_ByteArray_getBufferPtrAddr = 1059; // native
const uint32_t flash_utils_ByteArray_getBufferArrayAddr = 1060; // native
const uint32_t flash_utils_ByteArray_getBufferArrayPtrAddr = 1061; // native
...
extern double flash_utils_ByteArray_getBufferPtrAddr_thunk(MethodEnv* env, uint32_t argc, Atom* argv);
extern double flash_utils_ByteArray_getBufferPtrAddr_sampler_thunk(MethodEnv* env, uint32_t argc, Atom* argv);
...
extern double flash_utils_ByteArray_getBufferArrayPtrAddr_thunk(MethodEnv* env, uint32_t argc, Atom* argv);
extern double flash_utils_ByteArray_getBufferArrayPtrAddr_sampler_thunk(MethodEnv* env, uint32_t argc, Atom* argv);
