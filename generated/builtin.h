...
const uint32_t Object_private__getSizeOfInstance = 27; // native
const uint32_t Object_private__getTotalSize = 28; // native
const uint32_t Object_private__getExtraSize = 29; // native
const uint32_t Object_private__getSlotAreaSize = 30; // native
const uint32_t Object_protected__dontEnumPrototype = 31; // abc
const uint32_t Object_init = 32; // abc
const uint32_t Object__init = 44; // abc
const uint32_t Object_AS3_isPrototypeOf = 45; // abc
const uint32_t Object_AS3_hasOwnProperty = 46; // abc
const uint32_t Object_AS3_propertyIsEnumerable = 47; // abc
const uint32_t Class_prototype_get = 50; // native
const uint32_t Function_createEmptyFunction = 57; // abc
const uint32_t Function_prototype_get = 58; // native
const uint32_t Function_prototype_set = 59; // native
const uint32_t Function_length_get = 60; // native
const uint32_t Function_AS3_call = 61; // native
const uint32_t Function_AS3_apply = 62; // native
const uint32_t Namespace_prefix_get = 67; // native
const uint32_t Namespace_uri_get = 68; // native
const uint32_t Namespace_AS3_valueOf = 69; // abc
const uint32_t Namespace_AS3_toString = 70; // abc
const uint32_t Boolean_AS3_toString = 75; // abc
const uint32_t Boolean_AS3_valueOf = 76; // abc
const uint32_t Number_abs = 84; // native
const uint32_t Number_acos = 85; // native
const uint32_t Number_asin = 86; // native
const uint32_t Number_atan = 87; // native
const uint32_t Number_ceil = 88; // native
const uint32_t Number_cos = 89; // native
const uint32_t Number_exp = 90; // native
const uint32_t Number_floor = 91; // native
const uint32_t Number_log = 92; // native
const uint32_t Number_round = 93; // native
const uint32_t Number_sin = 94; // native
const uint32_t Number_sqrt = 95; // native
const uint32_t Number_tan = 96; // native
const uint32_t Number_atan2 = 97; // native
const uint32_t Number_pow = 98; // native
const uint32_t Number_max = 99; // native
const uint32_t Number_min = 100; // native
const uint32_t Number_random = 101; // native
const uint32_t Number_private__numberToString = 102; // native
const uint32_t Number_private__convert = 103; // native
const uint32_t Number_private__minValue = 104; // native
const uint32_t Number_AS3_toString = 105; // abc
const uint32_t Number_AS3_valueOf = 106; // abc
const uint32_t Number_AS3_toExponential = 107; // abc
const uint32_t Number_AS3_toPrecision = 108; // abc
const uint32_t Number_AS3_toFixed = 109; // abc
const uint32_t int_AS3_toString = 117; // abc
const uint32_t int_AS3_valueOf = 118; // abc
const uint32_t int_AS3_toExponential = 119; // abc
const uint32_t int_AS3_toPrecision = 120; // abc
const uint32_t int_AS3_toFixed = 121; // abc
const uint32_t uint_AS3_toString = 129; // abc
const uint32_t uint_AS3_valueOf = 130; // abc
const uint32_t uint_AS3_toExponential = 131; // abc
const uint32_t uint_AS3_toPrecision = 132; // abc
const uint32_t uint_AS3_toFixed = 133; // abc
const uint32_t String_AS3_fromCharCode = 154; // native
const uint32_t String_private__match = 155; // native
const uint32_t String_private__replace = 156; // native
const uint32_t String_private__search = 157; // native
const uint32_t String_private__split = 158; // native
const uint32_t String_length_get = 159; // native
const uint32_t String_private__indexOf = 160; // native
const uint32_t String_AS3_indexOf = 161; // native
const uint32_t String_private__lastIndexOf = 162; // native
const uint32_t String_AS3_lastIndexOf = 163; // native
const uint32_t String_AS3_charAt = 164; // native
const uint32_t String_AS3_charCodeAt = 165; // native
const uint32_t String_AS3_concat = 166; // abc
const uint32_t String_AS3_localeCompare = 167; // native
const uint32_t String_AS3_match = 168; // abc
const uint32_t String_AS3_replace = 169; // abc
const uint32_t String_AS3_search = 170; // abc
const uint32_t String_private__slice = 171; // native
const uint32_t String_AS3_slice = 172; // native
const uint32_t String_AS3_split = 173; // abc
const uint32_t String_private__substring = 174; // native
const uint32_t String_AS3_substring = 175; // native
const uint32_t String_private__substr = 176; // native
const uint32_t String_AS3_substr = 177; // native
const uint32_t String_AS3_toLowerCase = 178; // native
const uint32_t String_AS3_toLocaleLowerCase = 179; // abc
const uint32_t String_AS3_toUpperCase = 180; // native
const uint32_t String_AS3_toLocaleUpperCase = 181; // abc
const uint32_t String_AS3_toString = 182; // abc
const uint32_t String_AS3_valueOf = 183; // abc
const uint32_t Array_private__join = 206; // abc
const uint32_t Array_private__pop = 207; // native
const uint32_t Array_private__reverse = 208; // native
const uint32_t Array_private__concat = 209; // native
const uint32_t Array_private__shift = 210; // native
const uint32_t Array_private__slice = 211; // native
const uint32_t Array_private__unshift = 212; // native
const uint32_t Array_private__splice = 213; // native
const uint32_t Array_private__sort = 214; // native
const uint32_t Array_private__sortOn = 215; // native
const uint32_t Array_private__indexOf = 216; // native
const uint32_t Array_private__lastIndexOf = 217; // native
const uint32_t Array_private__every = 218; // native
const uint32_t Array_private__filter = 219; // native
const uint32_t Array_private__forEach = 220; // native
const uint32_t Array_private__map = 221; // native
const uint32_t Array_private__some = 222; // native
const uint32_t Array_length_get = 223; // native
const uint32_t Array_length_set = 224; // native
const uint32_t Array_private_set_length = 225; // abc
const uint32_t Array_AS3_join = 227; // abc
const uint32_t Array_AS3_pop = 228; // native
const uint32_t Array_AS3_push = 229; // native
const uint32_t Array_AS3_reverse = 230; // abc
const uint32_t Array_AS3_concat = 231; // abc
const uint32_t Array_AS3_shift = 232; // abc
const uint32_t Array_AS3_slice = 233; // abc
const uint32_t Array_AS3_unshift = 234; // native
const uint32_t Array_AS3_splice = 235; // abc
const uint32_t Array_AS3_sort = 236; // abc
const uint32_t Array_AS3_sortOn = 237; // abc
const uint32_t Array_AS3_indexOf = 238; // abc
const uint32_t Array_AS3_lastIndexOf = 239; // abc
const uint32_t Array_AS3_every = 240; // abc
const uint32_t Array_AS3_filter = 241; // abc
const uint32_t Array_AS3_forEach = 242; // abc
const uint32_t Array_AS3_map = 243; // abc
const uint32_t Array_AS3_some = 244; // abc
const uint32_t __AS3___vec_Vector_object_private_castToThisType = 267; // abc
const uint32_t __AS3___vec_Vector_object_private__every = 268; // native
const uint32_t __AS3___vec_Vector_object_private__forEach = 269; // native
const uint32_t __AS3___vec_Vector_object_private__some = 270; // native
const uint32_t __AS3___vec_Vector_object_private__sort = 271; // native
const uint32_t __AS3___vec_Vector_object_private_newThisType = 273; // native
const uint32_t __AS3___vec_Vector_object_length_get = 274; // native
const uint32_t __AS3___vec_Vector_object_length_set = 275; // native
const uint32_t __AS3___vec_Vector_object_fixed_set = 276; // native
const uint32_t __AS3___vec_Vector_object_fixed_get = 277; // native
const uint32_t __AS3___vec_Vector_object_AS3_toString = 278; // abc
const uint32_t __AS3___vec_Vector_object_AS3_toLocaleString = 279; // abc
const uint32_t __AS3___vec_Vector_object_AS3_join = 280; // abc
const uint32_t __AS3___vec_Vector_object_private__concat = 281; // abc
const uint32_t __AS3___vec_Vector_object_AS3_every = 282; // abc
const uint32_t __AS3___vec_Vector_object_AS3_forEach = 283; // abc
const uint32_t __AS3___vec_Vector_object_AS3_map = 284; // abc
const uint32_t __AS3___vec_Vector_object_AS3_push = 285; // native
const uint32_t __AS3___vec_Vector_object_private__reverse = 286; // native
const uint32_t __AS3___vec_Vector_object_AS3_some = 287; // abc
const uint32_t __AS3___vec_Vector_object_private__slice = 288; // abc
const uint32_t __AS3___vec_Vector_object_private__splice = 289; // abc
const uint32_t __AS3___vec_Vector_object_private__spliceHelper = 290; // native
const uint32_t __AS3___vec_Vector_object_AS3_unshift = 291; // native
const uint32_t __AS3___vec_Vector_object_private__filter = 292; // native
const uint32_t __AS3___vec_Vector_object_private__map = 293; // native
const uint32_t __AS3___vec_Vector_object_private_clamp = 294; // abc
const uint32_t __AS3___vec_Vector_object_AS3_concat = 295; // abc
const uint32_t __AS3___vec_Vector_object_AS3_filter = 296; // abc
const uint32_t __AS3___vec_Vector_object_AS3_pop = 297; // native
const uint32_t __AS3___vec_Vector_object_AS3_reverse = 298; // abc
const uint32_t __AS3___vec_Vector_object_AS3_shift = 299; // native
const uint32_t __AS3___vec_Vector_object_AS3_slice = 300; // abc
const uint32_t __AS3___vec_Vector_object_AS3_sort = 301; // abc
const uint32_t __AS3___vec_Vector_object_AS3_splice = 302; // abc
const uint32_t __AS3___vec_Vector_object_AS3_indexOf = 303; // abc
const uint32_t __AS3___vec_Vector_object_AS3_lastIndexOf = 304; // abc
const uint32_t __AS3___vec_Vector_int_private_castToThisType = 325; // abc
const uint32_t __AS3___vec_Vector_int_private__every = 326; // native
const uint32_t __AS3___vec_Vector_int_private__forEach = 327; // native
const uint32_t __AS3___vec_Vector_int_private__some = 328; // native
const uint32_t __AS3___vec_Vector_int_private__sort = 329; // native
const uint32_t __AS3___vec_Vector_int_private_newThisType = 331; // native
const uint32_t __AS3___vec_Vector_int_length_get = 332; // native
const uint32_t __AS3___vec_Vector_int_length_set = 333; // native
const uint32_t __AS3___vec_Vector_int_fixed_set = 334; // native
const uint32_t __AS3___vec_Vector_int_fixed_get = 335; // native
const uint32_t __AS3___vec_Vector_int_AS3_toString = 336; // abc
const uint32_t __AS3___vec_Vector_int_AS3_toLocaleString = 337; // abc
const uint32_t __AS3___vec_Vector_int_AS3_join = 338; // abc
const uint32_t __AS3___vec_Vector_int_private__concat = 339; // abc
const uint32_t __AS3___vec_Vector_int_AS3_every = 340; // abc
const uint32_t __AS3___vec_Vector_int_AS3_forEach = 341; // abc
const uint32_t __AS3___vec_Vector_int_AS3_map = 342; // abc
const uint32_t __AS3___vec_Vector_int_AS3_push = 343; // native
const uint32_t __AS3___vec_Vector_int_private__reverse = 344; // native
const uint32_t __AS3___vec_Vector_int_AS3_some = 345; // abc
const uint32_t __AS3___vec_Vector_int_private__slice = 346; // abc
const uint32_t __AS3___vec_Vector_int_private__splice = 347; // abc
const uint32_t __AS3___vec_Vector_int_private__spliceHelper = 348; // native
const uint32_t __AS3___vec_Vector_int_AS3_unshift = 349; // native
const uint32_t __AS3___vec_Vector_int_private__filter = 350; // native
const uint32_t __AS3___vec_Vector_int_private__map = 351; // native
const uint32_t __AS3___vec_Vector_int_private_clamp = 352; // abc
const uint32_t __AS3___vec_Vector_int_AS3_concat = 353; // abc
const uint32_t __AS3___vec_Vector_int_AS3_filter = 354; // abc
const uint32_t __AS3___vec_Vector_int_AS3_pop = 355; // native
const uint32_t __AS3___vec_Vector_int_AS3_reverse = 356; // abc
const uint32_t __AS3___vec_Vector_int_AS3_shift = 357; // native
const uint32_t __AS3___vec_Vector_int_AS3_slice = 358; // abc
const uint32_t __AS3___vec_Vector_int_AS3_sort = 359; // abc
const uint32_t __AS3___vec_Vector_int_AS3_splice = 360; // abc
const uint32_t __AS3___vec_Vector_int_AS3_indexOf = 361; // abc
const uint32_t __AS3___vec_Vector_int_AS3_lastIndexOf = 362; // abc
const uint32_t __AS3___vec_Vector_uint_private_castToThisType = 383; // abc
const uint32_t __AS3___vec_Vector_uint_private__every = 384; // native
const uint32_t __AS3___vec_Vector_uint_private__forEach = 385; // native
const uint32_t __AS3___vec_Vector_uint_private__some = 386; // native
const uint32_t __AS3___vec_Vector_uint_private__sort = 387; // native
const uint32_t __AS3___vec_Vector_uint_private_newThisType = 389; // native
const uint32_t __AS3___vec_Vector_uint_length_get = 390; // native
const uint32_t __AS3___vec_Vector_uint_length_set = 391; // native
const uint32_t __AS3___vec_Vector_uint_fixed_set = 392; // native
const uint32_t __AS3___vec_Vector_uint_fixed_get = 393; // native
const uint32_t __AS3___vec_Vector_uint_AS3_toString = 394; // abc
const uint32_t __AS3___vec_Vector_uint_AS3_toLocaleString = 395; // abc
const uint32_t __AS3___vec_Vector_uint_AS3_join = 396; // abc
const uint32_t __AS3___vec_Vector_uint_private__concat = 397; // abc
const uint32_t __AS3___vec_Vector_uint_AS3_every = 398; // abc
const uint32_t __AS3___vec_Vector_uint_AS3_forEach = 399; // abc
const uint32_t __AS3___vec_Vector_uint_AS3_map = 400; // abc
const uint32_t __AS3___vec_Vector_uint_AS3_push = 401; // native
const uint32_t __AS3___vec_Vector_uint_private__reverse = 402; // native
const uint32_t __AS3___vec_Vector_uint_AS3_some = 403; // abc
const uint32_t __AS3___vec_Vector_uint_private__slice = 404; // abc
const uint32_t __AS3___vec_Vector_uint_private__splice = 405; // abc
const uint32_t __AS3___vec_Vector_uint_private__spliceHelper = 406; // native
const uint32_t __AS3___vec_Vector_uint_AS3_unshift = 407; // native
const uint32_t __AS3___vec_Vector_uint_private__filter = 408; // native
const uint32_t __AS3___vec_Vector_uint_private__map = 409; // native
const uint32_t __AS3___vec_Vector_uint_private_clamp = 410; // abc
const uint32_t __AS3___vec_Vector_uint_AS3_concat = 411; // abc
const uint32_t __AS3___vec_Vector_uint_AS3_filter = 412; // abc
const uint32_t __AS3___vec_Vector_uint_AS3_pop = 413; // native
const uint32_t __AS3___vec_Vector_uint_AS3_reverse = 414; // abc
const uint32_t __AS3___vec_Vector_uint_AS3_shift = 415; // native
const uint32_t __AS3___vec_Vector_uint_AS3_slice = 416; // abc
const uint32_t __AS3___vec_Vector_uint_AS3_sort = 417; // abc
const uint32_t __AS3___vec_Vector_uint_AS3_splice = 418; // abc
const uint32_t __AS3___vec_Vector_uint_AS3_indexOf = 419; // abc
const uint32_t __AS3___vec_Vector_uint_AS3_lastIndexOf = 420; // abc
const uint32_t __AS3___vec_Vector_double_private_castToThisType = 441; // abc
const uint32_t __AS3___vec_Vector_double_private__every = 442; // native
const uint32_t __AS3___vec_Vector_double_private__forEach = 443; // native
const uint32_t __AS3___vec_Vector_double_private__some = 444; // native
const uint32_t __AS3___vec_Vector_double_private__sort = 445; // native
const uint32_t __AS3___vec_Vector_double_private_newThisType = 447; // native
const uint32_t __AS3___vec_Vector_double_length_get = 448; // native
const uint32_t __AS3___vec_Vector_double_length_set = 449; // native
const uint32_t __AS3___vec_Vector_double_fixed_set = 450; // native
const uint32_t __AS3___vec_Vector_double_fixed_get = 451; // native
const uint32_t __AS3___vec_Vector_double_AS3_toString = 452; // abc
const uint32_t __AS3___vec_Vector_double_AS3_toLocaleString = 453; // abc
const uint32_t __AS3___vec_Vector_double_AS3_join = 454; // abc
const uint32_t __AS3___vec_Vector_double_private__concat = 455; // abc
const uint32_t __AS3___vec_Vector_double_AS3_every = 456; // abc
const uint32_t __AS3___vec_Vector_double_AS3_forEach = 457; // abc
const uint32_t __AS3___vec_Vector_double_AS3_map = 458; // abc
const uint32_t __AS3___vec_Vector_double_AS3_push = 459; // native
const uint32_t __AS3___vec_Vector_double_private__reverse = 460; // native
const uint32_t __AS3___vec_Vector_double_AS3_some = 461; // abc
const uint32_t __AS3___vec_Vector_double_private__slice = 462; // abc
const uint32_t __AS3___vec_Vector_double_private__splice = 463; // abc
const uint32_t __AS3___vec_Vector_double_private__spliceHelper = 464; // native
const uint32_t __AS3___vec_Vector_double_AS3_unshift = 465; // native
const uint32_t __AS3___vec_Vector_double_private__filter = 466; // native
const uint32_t __AS3___vec_Vector_double_private__map = 467; // native
const uint32_t __AS3___vec_Vector_double_private_clamp = 468; // abc
const uint32_t __AS3___vec_Vector_double_AS3_concat = 469; // abc
const uint32_t __AS3___vec_Vector_double_AS3_filter = 470; // abc
const uint32_t __AS3___vec_Vector_double_AS3_pop = 471; // native
const uint32_t __AS3___vec_Vector_double_AS3_reverse = 472; // abc
const uint32_t __AS3___vec_Vector_double_AS3_shift = 473; // native
const uint32_t __AS3___vec_Vector_double_AS3_slice = 474; // abc
const uint32_t __AS3___vec_Vector_double_AS3_sort = 475; // abc
const uint32_t __AS3___vec_Vector_double_AS3_splice = 476; // abc
...
const uint32_t flash_utils_ByteArray_getByteArrayAddr = 1057; // native
const uint32_t flash_utils_ByteArray_getBufferAddr = 1058; // native
const uint32_t flash_utils_ByteArray_getBufferArrayAddr = 1059; // native
const uint32_t flash_utils_ByteArray_length_get = 1060; // native
const uint32_t flash_utils_ByteArray_length_set = 1061; // native
const uint32_t flash_utils_ByteArray_writeObject = 1062; // native
const uint32_t flash_utils_ByteArray_readObject = 1063; // native
const uint32_t flash_utils_ByteArray_deflate = 1064; // abc
const uint32_t flash_utils_ByteArray_private__compress = 1065; // native
const uint32_t flash_utils_ByteArray_compress = 1066; // abc
const uint32_t flash_utils_ByteArray_inflate = 1067; // abc
const uint32_t flash_utils_ByteArray_private__uncompress = 1068; // native
const uint32_t flash_utils_ByteArray_uncompress = 1069; // abc
const uint32_t flash_utils_ByteArray_toString = 1070; // abc
const uint32_t flash_utils_ByteArray_private__toString = 1071; // native
const uint32_t flash_utils_ByteArray_bytesAvailable_get = 1072; // native
const uint32_t flash_utils_ByteArray_position_get = 1073; // native
const uint32_t flash_utils_ByteArray_position_set = 1074; // native
const uint32_t flash_utils_ByteArray_objectEncoding_get = 1075; // native
const uint32_t flash_utils_ByteArray_objectEncoding_set = 1076; // native
const uint32_t flash_utils_ByteArray_endian_get = 1077; // native
const uint32_t flash_utils_ByteArray_endian_set = 1078; // native
const uint32_t flash_utils_ByteArray_clear = 1079; // native
const uint32_t flash_utils_ByteArray_atomicCompareAndSwapIntAt = 1080; // native
const uint32_t flash_utils_ByteArray_atomicCompareAndSwapLength = 1081; // native
const uint32_t flash_utils_ByteArray_shareable_get = 1082; // native
const uint32_t flash_utils_ByteArray_shareable_set = 1083; // native
const uint32_t flash_utils_ObjectOutput_writeBytes = 1086; // native
const uint32_t flash_utils_ObjectOutput_writeBoolean = 1087; // native
const uint32_t flash_utils_ObjectOutput_writeByte = 1088; // native
const uint32_t flash_utils_ObjectOutput_writeShort = 1089; // native
const uint32_t flash_utils_ObjectOutput_writeInt = 1090; // native
const uint32_t flash_utils_ObjectOutput_writeUnsignedInt = 1091; // native
const uint32_t flash_utils_ObjectOutput_writeFloat = 1092; // native
const uint32_t flash_utils_ObjectOutput_writeDouble = 1093; // native
const uint32_t flash_utils_ObjectOutput_writeMultiByte = 1094; // native
const uint32_t flash_utils_ObjectOutput_writeUTF = 1095; // native
const uint32_t flash_utils_ObjectOutput_writeUTFBytes = 1096; // native
const uint32_t flash_utils_ObjectOutput_writeObject = 1097; // native
const uint32_t flash_utils_ObjectOutput_objectEncoding_get = 1098; // native
const uint32_t flash_utils_ObjectOutput_objectEncoding_set = 1099; // native
const uint32_t flash_utils_ObjectOutput_endian_get = 1100; // native
const uint32_t flash_utils_ObjectOutput_endian_set = 1101; // native
const uint32_t flash_net_DynamicPropertyOutput_writeDynamicProperty = 1105; // native
...
extern double flash_utils_ByteArray_getByteArrayAddr_thunk(MethodEnv* env, uint32_t argc, Atom* argv);
extern double flash_utils_ByteArray_getByteArrayAddr_sampler_thunk(MethodEnv* env, uint32_t argc, Atom* argv);
extern double flash_utils_ByteArray_getBufferAddr_thunk(MethodEnv* env, uint32_t argc, Atom* argv);
extern double flash_utils_ByteArray_getBufferAddr_sampler_thunk(MethodEnv* env, uint32_t argc, Atom* argv);
extern double flash_utils_ByteArray_getBufferArrayAddr_thunk(MethodEnv* env, uint32_t argc, Atom* argv);
extern double flash_utils_ByteArray_getBufferArrayAddr_sampler_thunk(MethodEnv* env, uint32_t argc, Atom* argv);
...
extern avmplus::Atom Object_private__getSizeOfInstance_thunk(MethodEnv* env, uint32_t argc, Atom* argv);
extern avmplus::Atom Object_private__getSizeOfInstance_sampler_thunk(MethodEnv* env, uint32_t argc, Atom* argv);
extern avmplus::Atom Object_private__getTotalSize_thunk(MethodEnv* env, uint32_t argc, Atom* argv);
extern avmplus::Atom Object_private__getTotalSize_sampler_thunk(MethodEnv* env, uint32_t argc, Atom* argv);
extern avmplus::Atom Object_private__getExtraSize_thunk(MethodEnv* env, uint32_t argc, Atom* argv);
extern avmplus::Atom Object_private__getExtraSize_sampler_thunk(MethodEnv* env, uint32_t argc, Atom* argv);
extern avmplus::Atom Object_private__getSlotAreaSize_thunk(MethodEnv* env, uint32_t argc, Atom* argv);
extern avmplus::Atom Object_private__getSlotAreaSize_sampler_thunk(MethodEnv* env, uint32_t argc, Atom* argv);
